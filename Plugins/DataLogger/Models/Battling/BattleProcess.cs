...
namespace LynLogger.Models.Battling
{
    ...
    {
        IList<BattleProcess.ShipInfo> EnemyShips { get; }
        IList<BattleProcess.ShipInfo> OurShips { get; }
    }
    ...
    public partial class BattleProcess : AbstractDSSerializable<BattleProcess>, ICloneable, IShipInfoHolder
    {
        ...
        public IList<TorpedoInfo> OpeningTorpedoAttack => ZwOpeningTorpedoAttack ?? (ZwOpeningTorpedoAttack = new TorpedoInfo[0]);
        public IList<TorpedoInfo> ClosingTorpedoAttack => ZwClosingTorpedoAttack ?? (ZwClosingTorpedoAttack = new TorpedoInfo[0]);
        public IList<ShipHpStatus> OurShipBattleEndHp => ZwOurShipBattleEndHp ?? (ZwOurShipBattleEndHp = CollectionsEx.Sequence(1, OurShips.Count).Select(x => new ShipHpStatus(x, this)).ToArray());
        public IList<ShipHpStatus> EnemyShipBattleEndHp => ZwEnemyShipBattleEndHp ?? (ZwEnemyShipBattleEndHp = CollectionsEx.Sequence(7, EnemyShips.Count).Select(x => new ShipHpStatus(x, this)).ToArray());
        ...
        public IList<BombardInfo> BombardRound1 => ZwBombardRound1;
        public IList<BombardInfo> BombardRound2 => ZwBombardRound2;
        ...
        public partial class NightWarInfo : AbstractDSSerializable<NightWarInfo>, ICloneable, IShipInfoHolder
        {
            ...
            public IList<ShipInfo> EnemyShips => _parent?.EnemyShips ?? ZwEnemyShips;
            public IList<ShipInfo> OurShips => _parent?.OurShips ?? ZwOurShips;
            public IList<BombardInfo> Bombard => ZwBombard ?? (ZwBombard = new BombardInfo[0]);
        ...
        public partial class ShipInfo : AbstractDSSerializable<ShipInfo>, ICloneable
        {
            ...
            public IList<EquiptInfo> Equipts => ZwEquipts;
        ...
        public partial class AirWarfareInfo : AbstractDSSerializable<AirWarfareInfo>, ICloneable
        {
            ...
            public IList<EquiptInfo> CutInEquipts => ZwCutInEquipts;
            ...
            public IList<Stage3Report> OurStage3Report => ZwOurStage3Report ?? (ZwOurStage3Report = CollectionsEx.Zip(ZwOurShipDamages, ZwOurShipBombed, ZwOurShipTorpedoed, CollectionsEx.Range(1, 7),
            ...
            public IList<Stage3Report> EnemyStage3Report => ZwEnemyStage3Report ?? (ZwEnemyStage3Report = CollectionsEx.Zip(ZwEnemyShipDamages, ZwEnemyShipBombed, ZwEnemyShipTorpedoed, CollectionsEx.Range(7, 13),
                        (damage, bombed, torpedoed, ship) =>
                            new Stage3Report() {
                                ZwShip = ship,
                                ZwDamage = damage,
        ...
        public partial class BombardInfo : AbstractDSSerializable<BombardInfo>, ICloneable
        {
            ...
            public IList<EquiptInfo> Equipts => ZwEquipts;
            public IList<int> Damage => ZwDamage;
            public IEnumerable<KeyValuePair<ShipInfo, int>> AttackInfos => Enumerable.Zip(To, Damage, (a, b) => new KeyValuePair<ShipInfo, int>(a, b));
        ...
        public partial class SupportInfo : AbstractDSSerializable<SupportInfo>, ICloneable
        {
            ...
            public IList<ShipInfo> SupportShips => ZwSupportShips;
        ...
        {
            [Serialize(0)] private FuzzyInt ZwDeliveredDamage;
            ...
            public FuzzyInt DeliveredDamage => ZwDeliveredDamage;
